...
export default function Home() {
  return (
    <div className='flex p-4 sm:p-8 md:p-12 flex-col sm:flex-row gap-4 sm:gap-0 min-h-screen items-start justify-start'>
      {/* Left Content Column */}
      <div className='flex w-full sm:basis-2/4 flex-col gap-3 sm:gap-6 items-start justify-start h-full'>
        ...
        <p className='text-neutral-500 text-xs sm:text-sm md:text-base -space-y-1 mt-3 sm:mt-4 md:mt-6 w-full'>
      ...
      <div className='w-full sm:basis-2/4 flex items-center justify-center sm:justify-end mt-6 sm:mt-12 px-2 sm:px-0'>
        <Image
          className='w-full max-w-[280px] sm:max-w-md md:max-w-lg lg:max-w-xl'
          src='/new-group.png'
